...
if (!isset($_SESSION['user_id']) || $_SESSION['role_id'] != 3) { // Assuming 3 is the role_id for vendeur
    // Redirect to login page if not logged in or not a vendeur
    header("Location: ../login.php");
    exit();
}

// Set page title
$pageTitle = "Vendeur Dashboard";
?>
...
<body>
    ...
    <div class="main-content">
        <div id="dashboard-content">
            ...
            <p>Chargement du tableau de bord du vendeur...</p>
        </div>
    </div>
